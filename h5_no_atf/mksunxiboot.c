...
/* 12-3-2018 -- this flags my hacks and additions,
 * which I need because I don't have the whole complex U-Boot
 * include file scheme.
 * I build this on a little endian x86, so the le32 macros
 * are trivial pass throughs. (see include/compiler.h).
 */
#define TJT
