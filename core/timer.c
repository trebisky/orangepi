...
/* "M" is the main timer, and the only one
 * that is really documented in the datasheet
 */
/* What about the R timer ?
 * The datasheet gives a base address and allocates
 * 4 interrupts.  But says nothing else.
 * Simply trying it does not work.
 * Perhaps it has clock and rest control bits somewhere.
 * Not worth intense efforts.
 */

#define M_TIMER_BASE	( (struct h3_timer *) 0x01c20c00)
#define R_TIMER_BASE	( (struct h3_timer *) 0x01f00800)
#define TIMER_BASE	M_TIMER_BASE
